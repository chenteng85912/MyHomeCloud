...
- (void)calculateSizeConstrainedToSize{
    ...
    CGSize houseSize = [self.houseName sizeWithMaxSize:CGSizeMake(dWidth-cellX*3, MAXFLOAT) fontSize:NAME_FONT];
    ...
    CGSize totalSize = [self.totalPrice sizeWithMaxSize:CGSizeMake((dWidth-cellX*3)/2, MAXFLOAT) fontSize:TOTAL_FONT];
    ...
    CGSize unitSize = [self.unitPrice sizeWithMaxSize:CGSizeMake((dWidth-cellX*3)/2, MAXFLOAT) fontSize:TOTAL_FONT];
